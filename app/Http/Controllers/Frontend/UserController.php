...
class UserController extends Controller {
    ...
    public function ProductDetails($id, $slug) {
        ...
        // $breadcrumb = SubCategory::with('category')->where('id', $product->category_id)->get();
    ...
    public function SubCatWiseProduct($subcat_id, $slug) {
        ...
        $breadcrumb = SubCategory::with('category')->where('id', $subcat_id)->get();

        return view('frontend.product.subcategory_view', compact('products', 'categories', 'breadcrumb'));
    }
    ...
    public function SubSubCatWiseProduct($subsubcat_id, $slug) {
        ...
        $breadsubsubcat = SubSubCategory::with(['subcategory', 'category'])->where('id', $subsubcat_id)->get();
    ...
    public function AdvancedSearch(Request $request) {
        ...
        return view('frontend.product.advanced_search', compact('products'));
    } // end method 
}
