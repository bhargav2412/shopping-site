        ...
        <div class="row">
            <div class="box box-widget widget-user">
                ...
                <div class="widget-user-image">
                    <img class="rounded-circle" src="{{ !empty($AdminData->profile_photo_path) ? url('upload/admin_images/' . $AdminData->profile_photo_path) : url('backend/upload/no_image.jpg') }}" alt="User Avatar">
                </div>
