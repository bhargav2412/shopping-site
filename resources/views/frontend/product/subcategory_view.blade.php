    ...
    <div class='container'>
        <div class='row'>
                    ...
                    <div class="sidebar-filter">
                        ...
                        <div class="sidebar-widget wow fadeInUp">
                            ...
                            <div class="sidebar-widget-body m-t-10">
                                <div class="price-range-holder"> <span class="min-max"> <span class="pull-left">$200.00</span> <span class="pull-right">$800.00</span>
                                    </span>
            ...
            <div class='col-md-9'>
                ...
                /
                @foreach($breadcrumb as $item)
                <span class="badge badge-danger" style="background: #808080">{{ $item->subcategory_name_en }} </span>
                @endforeach
                                ...
                                <div class="lbl-cnt"> <span class="lbl">Sort by</span>
                                    <div class="fld inline">
                                        <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                            <button data-toggle="dropdown" type="button" class="btn dropdown-toggle"> Position <span class="caret"></span>
                                            </button>
