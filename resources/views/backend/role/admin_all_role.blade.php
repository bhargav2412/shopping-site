                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <img src="{{ !empty($item->profile_photo_path) ? url('upload/admin_images/' . $item->profile_photo_path) : url('backend/upload/no_image.jpg') }}" style="width: 50px; height: 50px;"> </td>
                                        <td> {{ $item->name }} </td>
                                        <td> {{ $item->email  }} </td>
