                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_size_en" class="form-control"
                                                    value="large,medium,small" data-role="tagsinput" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_color_en" class="form-control"
                                                    value="red,green,white" data-role="tagsinput" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_color_hin" class="form-control"
                                                    value="red,blue,black" data-role="tagsinput" required="">
                                ...
                                <div class="row"> {{-- start 7th row --}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="short_descp_hin" class="form-control"
                                ...
                                <div class="row"> {{-- start 8th row --}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="editor2" name="long_descp_hin" class="form-control"
                                                    placeholder="Textarea text" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                    </div> {{-- end col md 4 --}}
...
$(document).ready(function() {
    // Category via get sub category list
    ...
    // SubCategory via get SubSubCategory list
